...
# from utils import (
#     register_chat_id, TOKENS, get_token_price, TELEGRAM_API_URL, send_message,
#     send_token_info, get_fear_and_greed_index, get_market_dominance
# )
# from background import build_price_message, start_price_checker
...
#         await send_price(chat_id)
#     elif text.startswith("/info_"):
#         command = text[6:].replace("_", "-")
#         if command in TOKENS:
#             await send_token_info(chat_id, command)
...
# from utils import register_chat_id, TOKENS, get_token_price, TELEGRAM_API_URL, send_message
# from background import build_price_message, start_price_checker
...
#         "commands": [
#             {"command": "price", "description": "Get all token prices"},
#             {"command": "info_wiki-cat", "description": "Info about Wiki Cat"},
#             {"command": "info_bitcoin", "description": "Info about Bitcoin"},
#             {"command": "info_ethereum", "description": "Info about Ethereum"},
#             {"command": "info_ripple", "description": "Info about Ripple"},
#             {"command": "info_binancecoin", "description": "Info about Binance Coin"},
#             {"command": "info_solana", "description": "Info about Solana"},
#         ]
#     }
#     async with httpx.AsyncClient() as client:
#         await client.post(
...
#     task = asyncio.create_task(start_price_checker())
#     await set_bot_commands()
#     print('prices should be updating now')
#     yield
#     task.cancel()
...
#         await send_price(chat_id)
#     elif text.startswith("/info_"):
#         token = text[6:].replace("_", "-")
#         if token in TOKENS:
#             print(f'info of token: {token}')
#             await send_token_info(chat_id, token)
#         else:
#             await send_message(chat_id, "❌ Unknown token.")
#     else:
#         await send_message(chat_id, "👋 Send /price to get latest crypto prices!")
...
#     emoji = data["emoji"]
#     logo = data["logo"]
#     caption = f"{emoji} *{token_id.title()}*\n💵 Price: `${price}`"
