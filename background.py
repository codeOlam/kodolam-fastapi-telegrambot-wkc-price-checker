import asyncio
import httpx
from utils import TELEGRAM_API_URL, format_price, get_price_with_change, price_cache, TOKENS, CHANNEL_ID, \
    fetch_all_coinlore_prices
...
#     def line(k):
#         t = TOKENS[k]
#         price = prices.get(k, "N/A")
#         chg = price_cache.get(k, {}).get("chg_24", "—")
#         if chg:
#             try:
